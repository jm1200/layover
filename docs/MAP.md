...
| **2.1 — Verify + harden** | **Code done; city IA shipped; smoke pending** | Fixes shipped; RLS smoke: `docs/board/RLS-SMOKE.md`. City page: **Full layover · Eat · Do · Shop**. Object: **layover plan**. |
