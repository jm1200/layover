...
| **2.1 — Verify + harden** | **Code done; smoke pending** | Fixes shipped; RLS smoke: `docs/board/RLS-SMOKE.md`. **City IA UX cut** (layover plan + Eat/Do/Shop grouping) = pending shareholder yes — see brief 2026-08-21. No `apps/` until yes. |
...
| `/cities/[slug]` | Public | Layover plans + Eat/Do/Shop recs (today: two lists; IA cut pending yes) | Phase 2 |
