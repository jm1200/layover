...
**Homepage IA (2026-08-22):** Intel for crew, by crew. Three **Eat / Do / Buy** idea cards with photos (editorial examples — not limited to seeded cities) + **Where are you headed?** city search. No city chips on `/`. **The perfect layover** series is not on the landing (lives with layover plans). **Rejected on `/`:** “Steal the whole layover.” Do not put camping/Ontario here.
