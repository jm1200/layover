...
- [x] Public pages emit a share card (title, blurb, picture) for iMessage / WhatsApp / Slack / X
...
- **Pilot lock 2026-09-07 — city scan:** First look must show **Eat and Do and Buy** as equal doors. Cards on `/cities/[slug]` **and** `/cities/[slug]/eat|do|buy`: **small still + title**, not Instagram 4:5. Rec **detail** stays photo-first. Homepage `/` cards stay.
- **City tabs (2026-09-08):** Eat / Do / Buy / A day are real tabs (one panel). Full layover lives only on **A day**. Empty kind: no dump box. *Nobody’s filed Buy in {City} yet. Click Share your intel above to add a Buy recommendation.*
