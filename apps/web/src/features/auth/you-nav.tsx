...
export function YouNav({
  ...
  const summary =
    tone === "dark"
      ? "flex h-9 w-9 cursor-pointer list-none items-center justify-center overflow-hidden rounded-full text-white/90 ring-1 ring-white/40 hover:text-white hover:ring-white"
      : "flex h-9 w-9 cursor-pointer list-none items-center justify-center overflow-hidden rounded-full text-zinc-700 ring-1 ring-zinc-300 hover:text-zinc-900 hover:ring-zinc-500";
  ...
  return (
    <details className="relative">
      ...
      >
        <FaceCircle name={name} src={avatarUrl} size="sm" tone={tone} />
      </summary>
