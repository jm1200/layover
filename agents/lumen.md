...
6. **Pictures.** Upload yours, or check **AI still on publish**. She shrinks the file so they don’t have to. Preview is the **card crop** (4:5). She does **not** secretly reframe their photo — that’s their shot. Hate the crop → upload another. One AI still, after Publish. Never a gallery. Never a still just for the plan.
