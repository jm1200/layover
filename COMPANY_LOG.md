...
- **2026-08-27 — Dashboard feel-pass (John).** Dump is good. Sign-in (including admin) lands on `/dashboard`, not `/admin`. Header: Layover · Share your intel · Cities · **[profile icon]**. No word **You**. Sign out in the menu. Title **Your recommendations**. Menu **Your recs**. Cards: photos, posted date, city bold, days vs Eat/Do/Buy visually split. Quiet *or type it yourself* stays after the cards. Public city/place still do not say “rec.” Strings: `agents/lumen.md`, `features/auth.md`.
