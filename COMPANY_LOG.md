...
- **AI-maintained, almost no forms** is John’s contribution model (dictate → draft place/plan, at most one follow-up or form holes, optional generated image + map). Not built. Phase 4 territory. Forms stay until that ships.
...
- **2026-08-24 — Spend lock:** No production AI (or paid cloud upgrade) without John’s explicit yes — key **and** monthly cap. Raising quotas, $ cap, Imagine quality, extra stills, web search, city-hero refresh = John. Until invoices exist: **3 drafts/user/day**, one extract, **at most one** follow-up (users dictate; Sofia may use form holes instead). Kill switch with Phase 4; AI stays off until he says go. Not built.
