...
- **2026-08-25 — Rec photos.** Public rec page shows **all** pics (hero + plates). Hero = rec still (Lumen) until likes exist. Crew-added pics + reviews = later (Phase 3). Author plates still cap 3.
