...
- **2026-08-24 — Share UX (Sofia):** Users **will dictate**. **2026-09-08:** in-app **Tap to talk** records once and transcribes with **xAI STT** ($0.10/hr audio, same $20 cap). Keyboard is the or. Dump once → Lumen fills the draft → missing bits are **empty fields**. One spoken/typed question only if a **required** field is missing. Not a chat interview.
